...
# Your code here:
# -----------------------------------------------
def ReLu(array: np.array, cutoff: int = 0):
...
def neural_net_layer(array_2d: np.array, array_1d: np.array) -> np.array:
    return ReLu(np.matmul(array_2d, array_1d))
